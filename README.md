...
> 세대별 다문화 수용성 다양한 요인분석
> -2023
> -역할 : 데이터 분석, 정보조사
> -기여도 : 데이터 분석 90%, 정보수집 30%
>
> -목적: 증가하는 다문화 인구에 따른 세대별 수용성 요인을 분석
> -사용한 툴: Python
> -분석 기법: 로우데이터를 분석에 맞게 데이터 전처리와 로짓 회귀분석을 이용하여 세대별 다문화 수용을 분석
> -성과 : 교내 2023 경상대학 파이썬 코딩대회 2위.
...
> -미디어 리터러시가 청소년 만족도에 대한 영향력 분석 
> -2022
> -역할 : 데이터 분석, 정보조사
> -기여도 : 데이터 분석 80%, 정보수집 30%
> -목적: 공공 데이터를 활용하여 청소년의 미디어 및 스마트폰 활용 추세와 미디어 리터러시가 청소년 만족도에 미치는 영향력을 분석.
> -사용한 툴: Python, SPSS
> -분석 기법: 다중 회귀분석을 통해 각 변수가 청소년 만족도에 미치는 영향력을 분석하고, 데이터 전처리와 요인분석을 통해 변수를 추정.
> -성과: 변수 선정 정확성의 비중을 높임, 서울시 교육부 주최 공모전 본선 진출 
>
...
> -SVD(서포트 백터 머신) 기법을 활용하여 유저들의 도서 평점 예측.
> -역할 : 데이터 분석, 기여도 :데이터 분석 100%

> -제2회 KRX 주식 투자 알고리즘 경진대회
> -기본 데이터셋에서 크롤링하여 기업들의 EY, ROE 데이터셋을 구한 뒤 LSTM,과 ARIMA 기법으로 주가 상승 예측 
> -Private 순위 상위 11% 달성
> -역할 : 데이터 분석, 기여도 :데이터 분석 100%

> -이커머스 고객 세분화 분석 아이디어 경진대회 (진행중)
